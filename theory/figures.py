...
from theory import bridge as bridge_module
from theory import equilibrium
from theory.families import LinearCost, Primitives, QuadraticCost
from theory.sapians_style import (
    COLORS,
    footnote,
    guide,
    insight_title,
...
def fig11() -> tuple[Any, dict[str, Any]]:
    ...
    insight_title(
        ...
        "Tabela 3 col. (2), 2SGMM (pontos coloridos) contra Tabela 6 col. (2), OLS (cinza); coeficientes publicados em replication/published.json. A presença de LCC fica negativa nos dois estimadores.",
    )
    footnote(
        fig,
    ...
    payload = {
        ...
        "note": "Published coefficients only (replication/published.json); nothing re-estimated.",
    }
    return fig, payload
...
def draw_all(outdir: Path) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        "style": "SAPIANS scientific figure style (sapians-latex, MIT), see theory/sapians_style.py",
