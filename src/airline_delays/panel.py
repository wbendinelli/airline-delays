...
def city_month(
    ...
    *,
    ...
    city = fact_mod.add_congestion(city, day_hour)
    fact_mod.assert_unique(city, fact_mod.CITY_MONTH_KEY, "city_month")
    return city
